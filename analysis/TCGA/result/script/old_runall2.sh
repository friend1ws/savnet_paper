...
python rescue_hotspot.py ../gsm_out/gsm_file_list/ ../matome/omega.genomon_splicing_mutation.result.txt ../rescue/script/hotspot_all.txt > ../matome/omega.genomon_splicing_mutation.rescued.txt

cat ../matome/omega.genomon_splicing_mutation.result.txt ../matome/omega.genomon_splicing_mutation.rescued.txt > ../matome/omega.genomon_splicing_mutation.with_rescued.txt
