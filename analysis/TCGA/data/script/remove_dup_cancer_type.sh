...
do
    ...
    if [ -f ${oxog_file} ]
    then
        echo "python remove_dup_oxog.py ${mut_file} ${oxog_file} ../mutation/canonical.bed.gz ../mutation/noncanonical.bed.gz > ../mutation/${CTYPE}/${SAMPLE}.mutation.filt.txt"
        python remove_dup_oxog.py ${mut_file} ${oxog_file} ../mutation/canonical.bed.gz ../mutation/noncanonical.bed.gz > ../mutation/${CTYPE}/${SAMPLE}.mutation.filt.txt
    fi
