...
with open(input_file, 'r') as hin:
    ...
    for line in hin:
        ...
        if strand == "+":
            ...
            print >> hout, key + '\t' + motif_seq + '\t' + str(rel_pos) + '\t' + my_seq.reverse_complement(mref) + '\t' + my_seq.reverse_complement(malt) + '\t' + F[header2ind["Mutation_Type"]] + '\t' + F[header2ind["Is_Canonical"]] + '\t' + spidex 
